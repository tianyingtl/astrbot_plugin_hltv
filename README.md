...
`/hltv 防剧透 20` 会为当前正在追踪的赛事增加 20 分钟额外延迟，Rating 总延迟变为 21 分钟。
`/hltv antijutou -2` 会从该赛事当前额外延迟中减去 2 分钟，最低减到 0；总延迟始终至少为默认的 1 分钟。支持 `0.5` 等小数分钟。
...
| `/hltv 防剧透 <增减分钟>`、`/hltv antijutou <增减分钟>` | 调整当前追踪赛事的 Rating 额外延迟 |
